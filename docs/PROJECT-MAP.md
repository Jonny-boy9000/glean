...
| `docs/handoff/post-v0.10.0-handoff.md` | **Live forward handoff** — the ONLY active handoff. **Read this to pick up cold.** Convention: exactly one live handoff in `docs/handoff/`; when superseded it moves to `docs/archive/`. |
...
| `docs/archive/` | Shipped/superseded handoffs (`post-v0.9.0-handoff.md`, `post-v0.8.2-handoff.md`, `v0.8.2-handoff.md`). Historical reference only — never read these to pick up work. |
