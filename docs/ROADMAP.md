...
**Last updated:** 2026-06-01 (post-v0.7.1; `glean morning` receipt shipped, PR #3)
**Current release:** v0.7.1 (merge commit `8de2650`, PR #3)
**Branch state:** `main` clean; v0.7 complete bar the demo GIF + `npm publish` (distribution)
