...
**Last updated:** 2026-06-02 (v0.8.0 drain core built + in open PR off `feature/v0.8-drain`)
**Current release:** v0.7.1 published to npm; **v0.8.0 drain core in PR** (343 tests passing)
**Branch state:** `feature/v0.8-drain` ahead of `main` by the v0.8.0 drain core; PR open, awaiting merge
