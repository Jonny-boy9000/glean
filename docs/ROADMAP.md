...
**Last updated:** 2026-06-22 (v0.10.0 published — capacity-governor wave-2 + discovery optimization, the strategy-driven moat wave)
**Current release:** **v0.10.0 published** (`@jonny-boy9000/glean@0.10.0`, tag `v0.10.0`). v0.10.0 = the moat wave: user-input **week anchor** (`pacing.week_anchor`), opt-in **morning anti-spill**, **nightly pace-gated** drain (`pace-skip`), budget-fit **in-run re-ranking** + adaptive type-downweighting, and the designed-but-unbuilt **API-backend seam** ([ADR-0008](./decisions/0008-spawn-backend-seam.md)). Direction pinned by the 2026-06-22 strategy review ([`docs/strategy/2026-06-22-next-wave-strategy.md`](./strategy/2026-06-22-next-wave-strategy.md): stay narrow / subscription-only / Claude-native). Built on **v0.9.0** (also published 2026-06-22: capacity-governor wave-1 + the full-project-review hardening — [`docs/reviews/2026-06-21-full-project-review.md`](./reviews/2026-06-21-full-project-review.md)). **801 tests + 7 skips.**
