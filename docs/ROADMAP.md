...
**Last updated:** 2026-06-02 (v0.8.2 published to npm)
**Current release:** **v0.8.2 published to npm** (`@jonny-boy9000/glean@0.8.2`, merge `f1ff650`/PR #13, tag `v0.8.2`) — drain robustness: configurable circuit-breaker, mid-weekend re-discovery, anti-spill margin, `today`/`peek` window-aware aggregation, and the honest rate-limit signal (ADR-0001). 402 tests + 2 documented skips.
**Branch state:** `main` at v0.8.2, clean.
